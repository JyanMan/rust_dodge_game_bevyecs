...
pub fn movement_state() -> StateMachine<MovementState> {
    ...
    state_m.add_state(MovementState::lerping());
    state_m.add_state(MovementState::jump());
    state_m
}
pub fn combat_state() -> StateMachine<CombatState> {
    let mut state_m = StateMachine::new(CombatState::idle());
    state_m.add_state(CombatState::start_attack());
    state_m.add_state(CombatState::attacking());
    state_m.add_state(CombatState::knocked());
    state_m.add_state(CombatState::knock_end());
    state_m.add_state(CombatState::stop_attacking());
    state_m
}
